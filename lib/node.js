...
function Node(options) {
  ...
  this._startRepublishInterval();
  this._startNodeRefreshInterval();
...
/**
* Republish our original items every T_REPUBLISH
* #_startRepublishInterval
*/
Node.prototype._startRepublishInterval = function() {
  var self = this;
...
/**
* Refresh nodes if a lookup hasn't been done after T_REFRESH
* #_startNodeRefreshInterval
*/
Node.prototype._startNodeRefreshInterval = function() {
  var self = this;
...
Node.prototype._handleStore = function(params) {
  ...
  this._storage.put(params.key, params.value, function(err) {
    var contact = new Contact(params.address, params.port, params.nodeID);
